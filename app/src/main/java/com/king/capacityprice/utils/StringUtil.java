...
public class StringUtil {
    ...
    public static SpannableStringBuilder lightStr(String str, String lightStr) {
        ...
        style.setSpan(new RelativeSizeSpan(1.0f), fstart, fend, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
     ...
     * @return SpannableStringBuilder
     */
    public static SpannableStringBuilder lightStr(String str, String lightStr, String lightStr2, int color) {
        int fstart = str.indexOf(lightStr);
        int fstart2 = str.indexOf(lightStr2);
        int fend = fstart + lightStr.length();
        int fend2 = fstart2 + lightStr2.length();
        SpannableStringBuilder style = new SpannableStringBuilder(str);
        style.setSpan(new ForegroundColorSpan(color), fstart, fend, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
        style.setSpan(new ForegroundColorSpan(color), fstart2, fend2, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
        style.setSpan(new RelativeSizeSpan(1.0f), fstart, fend, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
        return style;
    }
