...
public class CommonValues {
    ...
    public static final String DEFAULT_SHAREDPREFERENCES_NAME = "academy_sp";
    public static final String LOCAL_FOLDER_NAME = "local_folder_name";//跳转到相册页的文件夹名称

    public static final String DB_NAME = "face3d";
    public static final String CHOOSENUM = "chooseNum";


    //apk下载地址
    public static final String APKDOWNLOADURL = "http://openinstall.io/c/o5vyqf/1";
    /**
     * 头像地址
     */
    ...
    /**
     * 判断用户是否存在 00：不存在  00:已存在
     */
    public static final String USER_EXIST = "00";
    public static final String USER_NOTEXIST = "01";

    //服务器返回message说明
    public static final String isY = "Y";
    public static final String isZ = "Z";
    public static final String isN = "N";
     ...
     * academyBucket
     */
    public static final String ACADEMYBUCKET = "academy";

    /**
     * uploadObject
     */
    public static final String UPLOADOBJECT = "academy/picture";

    /**
     * downloadObject
     */
    public static final String DOWNLOADOBJECT = "academy/picture";
}
