...
public class HProgressBarLoadingView extends View {
    ...
    public HProgressBarLoadingView(Context context) {
        this(context, null);
    }

    public HProgressBarLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HProgressBarLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
