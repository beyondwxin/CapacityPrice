...
import com.king.capacityprice.utils.MyUtils;
import com.king.capacityprice.utils.StringUtil;
import com.king.capacityprice.view.HProgressBarLoadingView;


public class BasicWebActivity extends BaseActivity {

    WebView webView;
    HProgressBarLoadingView mTopProgress;
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                if (newProgress >= 80) {
                    ...
                    mTopProgress.setCurProgress(100, 3000, new HProgressBarLoadingView.OnEndListener() {
                        @Override
                        public void onEnd() {
    ...
    private void errorOperation() {
        ...
        mTopProgress.setCurProgress(80, 3500, new HProgressBarLoadingView.OnEndListener() {
            @Override
            public void onEnd() {
                //3.5s 加载 80->100 进度的加载
                mTopProgress.setCurProgress(100, 3500, new HProgressBarLoadingView.OnEndListener() {
                    @Override
                    public void onEnd() {
    ...
    private void findView() {
        ...
        mTopProgress = (HProgressBarLoadingView) findViewById(R.id.top_progress);
